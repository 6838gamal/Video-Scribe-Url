...
# =========================
# إعداد اللغات للواجهة
# =========================
LANG = {
    "ar": {
        "title": "🎧 تفريغ محتوى الفيديو إلى نص",
        "desc": "ألصق رابط الفيديو من YouTube أو TikTok أو Facebook أو Instagram أو Google Drive أو رابط مباشر، واضغط الزر لتحصل على النص.",
        ...
        "public_warning": "⚠️ بعض الروابط (خاصة YouTube أو Facebook) قد تحتاج إلى ملفات cookies فعالة من المتصفح."
    },
    "en": {
        "title": "🎧 Transcribe Video or Audio to Text",
        "desc": "Paste a video link from YouTube, TikTok, Facebook, Instagram, Google Drive, or a direct file link, then click to extract the text.",
        ...
        "public_warning": "⚠️ Some links (especially YouTube or Facebook) may need valid browser cookies."
    }
}
...
lang = st.radio(LANG[st.session_state["lang"]]["select_lang"], ["العربية", "English"])
if lang == "English":
...
def download_audio_from_url(video_url):
    ...
    ydl_opts = {
        ...
        'quiet': True,
        'noplaylist': True,
        'cookiesfrombrowser': ('chrome',),  # يتطلب تثبيت cookies مرة واحدة فقط على الخادم
        'postprocessors': [{
